...
urlpatterns = [
    ...
    path('lesson-plans/command-center/', views.padi_command_center, name='padi_command_center'),
    path('lesson-plans/flight-manual/', views.padi_flight_manual, name='padi_flight_manual'),
    ...
    path('scheme-of-work/generate/', views.scheme_of_work_generate, name='scheme_of_work_generate'),
