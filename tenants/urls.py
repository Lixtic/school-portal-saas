...
urlpatterns = [
    ...
    path('landlord/agents/analytics/', views.agent_analytics, name='agent_analytics'),
    path('landlord/agents/briefing-room/', views.agent_briefing_room, name='agent_briefing_room'),
    path('landlord/agents/briefing-room/review/', views.agent_review_brief, name='agent_review_brief'),
    path('landlord/agents/briefing-room/regenerate/', views.agent_regenerate_brief, name='agent_regenerate_brief'),
    path('landlord/agents/pipeline/', views.agent_chain_view, name='agent_chain_view'),
    path('landlord/agents/pipeline/api/', views.agent_chain_api, name='agent_chain_api'),
    path('landlord/agents/pipeline/<int:pk>/', views.agent_chain_detail, name='agent_chain_detail'),
    ...
    path('landlord/agents/<str:agent_slug>/seo-crawl/', views.agent_seo_crawl, name='agent_seo_crawl'),
