...
TEACHER_ADDON_CATALOG = [
    ...
    },
    {
        ...
        'icon': 'bi-trophy',
        'tagline': 'Ace GES promotion \u2014 advance your career',
        'description': 'Master the GES Promotion Examination with 80+ expert-curated questions, timed mock exams and AI-generated practice across 5 key domains.',
        'plans': ['free', 'pro'],
        'category': 'professional',
        'prices': {'free': 0, 'pro': 49.99},
        'features': ['80+ curated promotion questions', 'Timed mock exams', 'AI practice assessments', '5 promotion exam domains'],
    },
    {
        'slug': 'letter-writer',
...
def dashboard_view(request):
    ...
    if profile.role == 'teacher':
        ...
        _ADDON_URL_MAP = {
            ...
            'promotion-prep': 'individual:promotion_dashboard',
